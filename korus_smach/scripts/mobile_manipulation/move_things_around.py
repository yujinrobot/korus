...
from korus_smach.state_machines import find_object_sm, pick_object_sm, pick_object_manual_sm, place_object_sm, place_object_manual_sm
...
def main():
    ...
    with sm:
        ...
        sm.userdata.pose_tabletop_a.pose.position.z = 0.65
        ...
        sm.userdata.pose_tabletop_b.pose.position.x = 0.8
        sm.userdata.pose_tabletop_b.pose.position.y = 0.0
        sm.userdata.pose_tabletop_b.pose.position.z = 0.6
        ...
        sm.userdata.pre_place_height = 0.10
        sm.userdata.place_dist = 0.15
        sm.userdata.post_place_height = 0.15
...
#                                            'preempted':'preempted'})
        ...
        smach.StateMachine.add('PickObject',
                               ...
                               remapping={'object_name':'pick_object_name',
                                          ...
                                          'pose_arm_default':'pose_arm_default'},
                               transitions={'picked':'PlaceObject',
                                            'pick_failed':'PlaceObject',
                                            'preempted':'preempted'})
...
#                                            'preempted':'preempted'})
        ...
        sm_place_object = place_object_manual_sm.createSM()
        smach.StateMachine.add('PlaceObject',
                               sm_place_object,
                               remapping={'place_pose':'pose_tabletop_a',
